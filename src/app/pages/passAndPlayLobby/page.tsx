  ...
  return (
    <div>
      ...
      <div className='relative'>
        <NavBar title="PNP' Settings" />
        <div className="absolute md:top-4 top-2 right-0 md:mr-10 flex z-50">
      ...
      <div className='flex flex-col items-center space-y-10 lg:pt-20 pt-8'>
        ...
        <div className='lg:flex flex-row justify-between whitespace-nowrap items-center sm:w-[400px]'>
        ...
        <div className='lg:flex flex-row justify-between whitespace-nowrap items-center sm:w-[400px]'>
          ...
          <div className='w-[100%] flex lg:justify-end justify-center space-x-1' >
